                        ...
                        <details className="group">
                          ...
                          <div className="mt-3 space-y-5">
                            <div>
                              ...
                              <p className="text-sm">
                                Please allow 1-3 business days for your orders
                                to be shipped from our warehouse via JNE, Paxel,
                                or Grab (Surabaya area only) according to your
                            ...
                            <div>
                              ...
                              <ul className="list-inside list-disc space-y-1 text-sm">
                                ...
                                <li className="ms-4">
                                  Exchanges for preorder items are not
                                  available, we will try to sell it for you but
                                  it will incur a 10% service fee
                                </li>
                                <li className="ms-4">
                                ...
                                <li className="ms-4">
                                  Exchanges that are damaged, soiled, perfumed
                                  or altered are not accepted and will be sent
                                  back to the customer (shipping cost will be
                                  covered by customer)
                                </li>
                              </ul>
                            </div>
              ...
              {product.ProductRecommendations.length > 0 && (
                <div>
                  ...
                  <div className="mb-7 grid h-full grid-cols-12 gap-x-2 gap-y-5 lg:gap-x-7">
                    {product.ProductRecommendations?.map((item, index) => (
                      <div
